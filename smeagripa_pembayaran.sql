...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2021 at 04:41 AM
...
INSERT INTO `tbl_angsuran_dpp` (`no_transaksi`, `nisn`, `kelas`, `nominal_bayar`, `tanggal`, `angsuran`) VALUES
(1, '1', 'X_ak_A', 200000, '2021-01-28', 1),
(2, '1', 'X_ak_A', 200000, '2021-01-28', 2),
(3, '1', 'X_ak_A', 200000, '2021-01-28', 3),
(4, '1', 'X_ak_A', 200000, '2021-01-28', 4),
(6, '2', 'X_ak_A', 400000, '2021-01-28', 1),
(7, '2', 'X_ak_A', 400000, '2021-01-28', 2),
(8, '4', 'X_tkj_A', 500000, '2021-01-28', 1),
(9, '4', 'X_tkj_A', 500000, '2021-01-28', 2),
(10, '4', 'X_tkj_A', 500000, '2021-01-28', 3),
(11, '2', 'X_ak_A', 400000, '2021-02-01', 3),
(12, '2', 'X_ak_A', 400000, '2021-02-01', 4),
(13, '2', 'X_ak_A', 400000, '2021-02-01', 5);
...
--
-- Dumping data for table `tbl_pembayaran_spp`
--
...
--
-- Table structure for table `tbl_pembayaran_ujian`
--
...
--
-- Dumping data for table `tbl_pembayaran_ujian`
--
...
INSERT INTO `tbl_siswa` (`nisn`, `nama_siswa`, `jk`, `tempat_lahir`, `tgl_lahir`, `alamat`, `no_telfon`, `kode_ta`, `tahun_keluar`, `kode_jurusan`, `kelas_1`, `kelas_2`, `kelas_3`, `kode_jenisspp`) VALUES
('1', 'Ulva Dwi Mariyani', 'perempuan', 'Malang', '2020-12-26', 'Surabaya', '085678908', 1, NULL, 'ak', 'X_ak_A', 'XI_ak_A', NULL, '8'),
('2', 'Alfrizal Rhama', 'laki-laki', 'Malang', '2020-12-25', 'Kalimantan', '12345', 1, NULL, 'ak', 'X_ak_A', 'XI_ak_A', 'XII_ak_A', '9'),
('3', 'Aqlan', 'laki-laki', 'Malang', '2020-12-26', 'Malanag', '09876', 1, NULL, 'tkj', 'X_tkj_A', NULL, NULL, '9'),
('4', 'Aqila', 'perempuan', 'Malang', '2020-12-26', 'Malang', '0876543456', 2, NULL, 'tkj', 'X_tkj_A', NULL, NULL, '9'),
('5', 'Jerome Polin', 'laki-laki', 'Malang', '2020-12-26', 'Surabaya', '987654', 2, NULL, 'tkj', 'X_tkj_B', NULL, NULL, '9'),
('6', 'Aldebaran', 'laki-laki', 'Malang', '2020-12-26', 'Malang', '09865', 2, NULL, 'ak', 'X_ak_A', NULL, NULL, '8'),
('7', 'Nabila', 'perempuan', 'Malang', '2020-12-26', 'Malang', '0766', 3, NULL, 'ak', 'X_ak_B', NULL, NULL, '9'),
('8', 'Zahra', 'perempuan', 'Malang', '2020-12-26', 'Malang', '09876578', 3, NULL, 'tkj', 'X_tkj_A', NULL, NULL, '9'),
('9', 'Jessica', 'perempuan', 'Malang', '2020-12-26', 'Malang', '0765478', 3, NULL, 'ak', 'X_ak_B', NULL, NULL, '9');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_tagihan_ujian`
--
...
--
-- Dumping data for table `tbl_tagihan_ujian`
--
...
--
-- Indexes for table `tbl_pembayaran_ujian`
--
...
--
-- Indexes for table `tbl_tagihan_ujian`
--
...
--
-- AUTO_INCREMENT for table `tbl_jenis_spp`
--
ALTER TABLE `tbl_jenis_spp`
...
--
-- AUTO_INCREMENT for table `tbl_pembayaran_ujian`
--
ALTER TABLE `tbl_pembayaran_ujian`
...
ALTER TABLE `tbl_siswa`
  ...
  ADD CONSTRAINT `tbl_siswa_ibfk_3` FOREIGN KEY (`kode_ta`) REFERENCES `tbl_tahun_ajaran` (`kode_ta`);
COMMIT;
